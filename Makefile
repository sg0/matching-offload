...
CXXFLAGS_THREADS +=  -DGRAPH_FT_LOAD=1 -DUSE_OMP_OFFLOAD -fopenmp -I${ROCM_PATH}/include  -fopenmp-targets=amdgcn-amd-amdhsa -Xopenmp-target=amdgcn-amd-amdhsa -march=gfx90a
